...
var BasicProgram, BasicProgramLine, KeyHelper, LineBuffer, LineParser, NumericExpressionParser, SyntaxRules,
...
SyntaxRules = (function() {
  function SyntaxRules() {
    this.rules = [["CLEAR"], ["RUN"], ["INFO"], ["LIST"], ["<line_number>", "<sp>", "REM"], ["<line_number>", "<sp>", "REM", "<sp>", "<characters>"], ["<line_number>", "<sp>", "<number_variable>", "<equals>", "<numeric_expression>"], ["<line_number>", "<sp>", "<string_variable>", "<equals>", "<string_expression>"], ["<line_number>", "<sp>", "GOTO", "<sp>", "<line_number>"], ["<line_number>", "<sp>", "GOSUB", "<sp>", "<line_number>"], ["<line_number>", "<sp>", "RETURN"], ["<line_number>", "<sp>", "IF", "<sp>", "<boolean_expression>", "<sp>", "THEN", "<sp>", "<line_number>"], ["<line_number>", "<sp>", "INPUT", "<sp>", "number_variable>"], ["<line_number>", "<sp>", "INPUT", "<sp>", "string_variable>"], ["<line_number>", "<sp>", "INPUT", "<sp>", "<string>", "<semicolon>", "<number_variable>"], ["<line_number>", "<sp>", "INPUT", "<sp>", "<string>", "<semicolon>", "<string_variable>"], ["<line_number>", "<sp>", "PRINT", "<sp>", "<string_expression>"], ["<line_number>", "<sp>", "PRINTLN"], ["<line_number>", "<sp>", "PRINTLN", "<sp>", "<string_expression>"], ["<line_number>", "<sp>", "CLEAR"], ["<line_number>", "<sp>", "TAB", "<sp>", "<integer>"], ["<line_number>", "<sp>", "TAB", "<sp>", "<integer>", "<comma>", "<integer>"]];
  }
