...
var BasicProgram, BasicProgramLine, BoolExpBuilder, BooleanExpressionParser, KeyHelper, LineParser, NumExpBuilder, NumericExpressionEvaluator, NumericExpressionParser, NumericVariableRegister, ParseHelpers, ProgramLineFormatter, ProgramLineManager, StrExpBuilder, StringExpressionParser, StringVariableRegister, SyntaxRules,
...
StringVariableRegister = (function() {
  ...
  StringVariableRegister.prototype.defined = function(name) {
    if (this.vars.hasOwnProperty(name)) {
      return "yes";
    } else {
      return "no";
  ...
  StringVariableRegister.prototype.set = function(name, value) {
    if (this.defined(name) === "no") {
      this.add_var(name);
    }
    return this.vars[name] = value;
  ...
  StringVariableRegister.prototype.get = function(name) {
    if (this.defined(name) === "no") {
      this.add_var(name);
    }
    return this.vars[name];
