...
xdescribe("Program controller", function() {
  beforeEach(function() {
    this.keys = new KeyTalker;
    this.prog = this.keys.controller.program_control;
    this.statement_runner = this.prog.statement_runner;
    this.helpers = this.statement_runner.helpers;
