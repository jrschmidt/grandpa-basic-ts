...
xdescribe("Program line listing", function() {
  beforeEach(function() {
  ...
  it("should return a hash of all program line objects", function() {
    var line_objects;
    line_objects = this.prog_lines.get_program_objects();
    ...
    return expect(line_objects["1299"].text).toEqual('1299 RETURN');
  });
