...
xdescribe("Action Controller - build object", function() {
  beforeEach(function() {
    this.keys = new KeyTalker;
    return this.controller = this.keys.controller;
  });
...
xdescribe("Action Controller - add line", function() {
  beforeEach(function() {
    this.keys = new KeyTalker;
    this.controller = this.keys.controller;
