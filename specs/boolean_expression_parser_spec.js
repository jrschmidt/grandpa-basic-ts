...
describe("Test boolean expression parser", function() {
  ...
  it("should return a 'not a boolean expression' token for any string that won't parse into a boolean expression", function() {
    var result;
  ...
  return it("should parse any properly formed boolean expression", function() {
    var po;
    po = this.parser.boolean_parse('$Y="Y"');
    ...
    po = this.parser.boolean_parse('N>0');
    expect(po).toEqual(jasmine.any(Array));
    ...
    po = this.parser.boolean_parse('I3<20');
    expect(po).toEqual(jasmine.any(Array));
    expect(po[0]).toEqual("<number_variable>");
    ...
    po = this.parser.boolean_parse('Z=A');
    expect(po).toEqual(jasmine.any(Array));
    expect(po[0]).toEqual("<number_variable>");
    ...
    po = this.parser.boolean_parse('Q1<>Q2');
    expect(po).toEqual(jasmine.any(Array));
    expect(po[0]).toEqual("<number_variable>");
    ...
    po = this.parser.boolean_parse('T<=30');
    expect(po).toEqual(jasmine.any(Array));
    expect(po[0]).toEqual("<number_variable>");
    ...
    po = this.parser.boolean_parse('H>=H0');
    expect(po).toEqual(jasmine.any(Array));
    expect(po[0]).toEqual("<number_variable>");
