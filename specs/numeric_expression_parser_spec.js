...
describe("Test numeric expression parser", function() {
  ...
  it("should return a 'not a numeric expression' token for any string that won't parse into a numeric expression", function() {
    var result;
  ...
  return it("should parse any properly formed numeric expression", function() {
    ...
    po = this.parser.numeric_parse("477+B");
    expect(po).toEqual(jasmine.any(Array));
    expect(po[0]).toEqual("<numeric_literal>");
    ...
    po = this.parser.numeric_parse("C^2");
    expect(po).toEqual(jasmine.any(Array));
    expect(po[0]).toEqual("<number_variable>");
    ...
    po = this.parser.numeric_parse("X*Y*Z");
    expect(po).toEqual(jasmine.any(Array));
    expect(po[0]).toEqual("<number_variable>");
    expect(po[1]).toEqual("X");
    ...
    po = this.parser.numeric_parse("28*(J+2)");
    expect(po).toEqual(jasmine.any(Array));
    expect(po[0]).toEqual("<numeric_literal>");
    ...
    po = this.parser.numeric_parse("W5+W7-4*(J^2+K^3)");
    expect(po).toEqual(jasmine.any(Array));
    expect(po[0]).toEqual("<number_variable>");
    ...
    po = this.parser.numeric_parse("(18-Q7)/(2.108*(14*M+17*X))");
    expect(po).toEqual(jasmine.any(Array));
