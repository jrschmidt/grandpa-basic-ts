describe "Action Controller", ->
  ...
  it "should build a valid program line object from a line with a numeric assignment statement", ->
    ...
    result = @controller.build_from_input('30 D=477+B')
  ...
  it "should build a valid program line object from a line with a string assignment statement", ->
    ...
    result = @controller.build_from_input('40 $E=$M+" IS NOT COMPLETE"')
  ...
  it "should build a valid program line object from a line with a GOTO statement", ->
    ...
    result = @controller.build_from_input('520 GOTO 880')
  ...
  it "should build a valid program line object from a line with a GOSUB statement", ->
    ...
    result = @controller.build_from_input('320 GOSUB 1200')
  ...
  it "should build a valid program line object from a line with a RETURN statement", ->
    ...
    result = @controller.build_from_input('1299 RETURN')
  ...
  it "should build a valid program line object from a line with an IF statement", ->
    ...
    result = @controller.build_from_input('150 IF Z<0 THEN 340')
    ...
    result = @controller.build_from_input('610 IF $T="INCOMPLETE" THEN 1680')
  ...
  it "should build a valid program line object from a line with an INPUT statement", ->
    ...
    result = @controller.build_from_input('110 INPUT R')
    ...
    result = @controller.build_from_input('120 INPUT $V')
    ...
    result = @controller.build_from_input('130 INPUT "HOW MANY?";M')
    ...
    result = @controller.build_from_input('140 INPUT "LAST NAME?";$N2')
  ...
  it "should build a valid program line object from a line with a PRINT statement", ->
    ...
    result = @controller.build_from_input('340 PRINT "WELCOME TO GRANDPA BASIC 1980"')
    ...
    result = @controller.build_from_input('350 PRINT $Z1')
    ...
    result = @controller.build_from_input('360 PRINT "LAST NAME = "+$N4')
  ...
  it "should build a valid program line object from a line with a PRINTLN statement", ->
    ...
    result = @controller.build_from_input('470 PRINTLN')
    ...
    result = @controller.build_from_input('480 PRINTLN "WELCOME TO GRANDPA BASIC 1980"')
    ...
    result = @controller.build_from_input('490 PRINTLN $Z1')
  ...
  it "should build a valid program line object from a line with a CLEARSCRN statement", ->
    ...
    result = @controller.build_from_input('940 CLEARSCRN')
  ...
  it "should build a valid program line object from a line with a TAB statement", ->
    ...
    result = @controller.build_from_input('870 TAB 28')
    ...
    result = @controller.build_from_input('880 TAB 12,44')
  ...
  it "should build a valid program line object from a line with an END statement", ->
    ...
    line_text = '999 END'
    result = @controller.build_from_input('999 END')
