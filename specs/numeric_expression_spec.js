...
describe("Numeric expression object", function() {
  ...
  it("should find the designated splitter token", function() {
    var helper, i, left, result, right, stack, test_data, test_set, _i, _j, _len, _ref, _results;
    helper = new NumExpHelper;
    test_data = [];
  ...
  return it("should build a NumericExpression object from a numeric expression 'parse object'", function() {
    ...
    po = ["<numeric_expression>", "<numeric_literal>", 477, "<plus>", "<number_variable>", "B", "<num_exp_end>"];
    expected = {
      exp: "<plus>",
      op1: {
        exp: "<num>",
    ...
    po = ["<numeric_expression>", "<number_variable>", "C", "<power>", "<numeric_literal>", 2, "<num_exp_end>"];
    expected = {
      exp: "<power>",
      op1: {
        exp: "<var>",
